...
def loaddb():
    ...
    db.session.add_all([
        ...
        Event(nom_groupe="L'orage", idFestival=1, nomEvent="Concert de l'orchestre", typeEvent="Concert", dateHeureDebutEvent="2025-02-19 20:00:00", dateHeureFinEvent="2025-02-19 22:00:00", estGratuit=True, adresseEvent="99 rue de la Nuit", nbPlaceEvent=800),
        Event(nom_groupe="La neige", idFestival=1, nomEvent="Concert de l'orchestre", typeEvent="Concert", dateHeureDebutEvent="2025-02-19 20:00:00", dateHeureFinEvent="2025-02-19 22:00:00", estGratuit=False, adresseEvent="55 rue Blanche", nbPlaceEvent=30),        
        Event(nom_groupe="La lune", idFestival=1, nomEvent="Concert de l'orchestre", typeEvent="Concert", dateHeureDebutEvent="2025-02-19 20:00:00", dateHeureFinEvent="2025-02-19 22:00:00", estGratuit=False, adresseEvent="8 rue du Sommeil", nbPlaceEvent=55),        
        Event(nom_groupe="Le soleil", idFestival=1, nomEvent="Concert de l'orchestre", typeEvent="Concert", dateHeureDebutEvent="2025-02-19 20:00:00", dateHeureFinEvent="2025-02-19 22:00:00", estGratuit=False, adresseEvent="3 rue du Groupe", nbPlaceEvent=10),
